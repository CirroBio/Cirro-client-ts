...
export interface GetSheetData1Request {
    projectId: string;
    sheetId: string;
...
export class SheetsApi extends runtime.BaseAPI {
     ...
     * Get sheet data
     */
    async getSheetData1Raw(requestParameters: GetSheetData1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SheetQueryResponse>> {
        if (requestParameters.projectId === null || requestParameters.projectId === undefined) {
            throw new runtime.RequiredError('projectId','Required parameter requestParameters.projectId was null or undefined when calling getSheetData1.');
        }

        if (requestParameters.sheetId === null || requestParameters.sheetId === undefined) {
            throw new runtime.RequiredError('sheetId','Required parameter requestParameters.sheetId was null or undefined when calling getSheetData1.');
        }

        if (requestParameters.sheetDataRequest === null || requestParameters.sheetDataRequest === undefined) {
            throw new runtime.RequiredError('sheetDataRequest','Required parameter requestParameters.sheetDataRequest was null or undefined when calling getSheetData1.');
        }
     ...
     * Get sheet data
     */
    async getSheetData1(requestParameters: GetSheetData1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SheetQueryResponse> {
        const response = await this.getSheetData1Raw(requestParameters, initOverrides);
        return await response.value();
    }
