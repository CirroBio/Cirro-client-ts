...
export enum Permission {
    ...
    ViewDashboardTemplate = 'VIEW_DASHBOARD_TEMPLATE',
    ...
    CreateSharedFilesystem = 'CREATE_SHARED_FILESYSTEM',
    ManageSharedFilesystems = 'MANAGE_SHARED_FILESYSTEMS',
    CreateCustomPipeline = 'CREATE_CUSTOM_PIPELINE',
    CreateCustomPipelineTenant = 'CREATE_CUSTOM_PIPELINE_TENANT',
    ManageCustomPipelines = 'MANAGE_CUSTOM_PIPELINES',
    ReadScratchBucket = 'READ_SCRATCH_BUCKET',
    ViewClassifications = 'VIEW_CLASSIFICATIONS',
    ViewContacts = 'VIEW_CONTACTS',
    ManageGovernance = 'MANAGE_GOVERNANCE',
    InvokePromptTemplate = 'INVOKE_PROMPT_TEMPLATE',
